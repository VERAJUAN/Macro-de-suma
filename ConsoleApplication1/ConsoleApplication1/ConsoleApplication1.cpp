...
void main(void) {
	...
	printf("%i\n", m1); //Imprimirá el valor entero almacenado en m1, consecuencia del macro con la condicional sin cerrar con paréntesis.
	printf("%i\n", m2); //Imprimirá el valor entero almacenado en m2, consecuencia del macro con la condicional cerrada por paréntesis.
